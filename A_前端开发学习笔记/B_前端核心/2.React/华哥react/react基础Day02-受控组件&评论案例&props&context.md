...
![](https://s2.loli.net/2022/02/26/UN1ovcWl8arnJKf.png)
...
![](https://s2.loli.net/2022/02/26/KfIuo4PDsgGeCLT.png)
...
![](https://s2.loli.net/2022/02/26/eyZSrdkujm6Ch4F.png)

- 接收数据：函数组件通过 参数 props接收数据，类组件通过 this.props接收数据

  - 函数组件获取

    ![](https://s2.loli.net/2022/02/26/hlpIua4P8LGmDzT.png)

  - 类组件获取

    ![](https://s2.loli.net/2022/02/26/m61BDnGkSJjKE8R.png)
...
![](https://s2.loli.net/2022/02/26/UILynVKSCoJ8p1l.png)
...
![](https://s2.loli.net/2022/02/26/TpJlyig6GNLvHr2.png)
...
![](https://s2.loli.net/2022/02/26/6JBjUwn2sNbzi71.png)

- 子组件通过props调用回调函数

![](https://s2.loli.net/2022/02/26/KIkaxNbHhwr2Xgv.png)
...
![](https://s2.loli.net/2022/02/26/YWU2dDJk9m4O3PI.png)
...
![](https://s2.loli.net/2022/02/26/COm1PUuhXeVQDMl.png)

- 使用Provider 组件作为父节点

![](https://s2.loli.net/2022/02/26/Y4fxqF2CtXhJQvA.png)

- 设置value属性，表示要传递的数据

![](https://s2.loli.net/2022/02/26/BGAPtJ5RKnWIXk7.png)

- 哪一层想要接收数据，就用Consumer进行包裹，在里面回调函数中的参数就是传递过来的值

![](https://s2.loli.net/2022/02/26/2kHeanbcjVDSd1F.png)
...
![](https://s2.loli.net/2022/02/26/ZIqSeuUfANtBLrH.png)
...
![](https://s2.loli.net/2022/02/26/Tm8H5PFU9MnrtxS.png)

- 作用：捕获使用组件时因为props导致的错误，给出明确的错误提示，增加组件的健壮性

![](https://s2.loli.net/2022/02/26/e8k72DIRpYjMa3Z.png)
...
![](https://s2.loli.net/2022/02/26/KrTRaCiQDFgzd7P.png)
...
![](https://s2.loli.net/2022/02/26/zdJrNpUvLOtKfZk.png)

### props的默认值

- 场景：分页组件 -> 每页显示条数

![](https://s2.loli.net/2022/02/26/nTDVoyrcJGQlNWZ.png)